...
const docTemplate = `{
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.AboutSection"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/admin/about": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create About Section Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateAboutSectionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/about/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update About Section Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateAboutSectionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/contact-inquiries": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status (new/read/responded)",
                        "name": "status",
                        "in": "query"
                    },
                    {
        ...
        "/api/admin/contact-inquiries/{id}": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "New status request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateInquiryStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/homepage": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Homepage Section Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/admin/homepage/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Homepage Section Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/admin/loan-inquiries": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status (new/contacted/approved/rejected)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search query (name, email, phone, city)",
                        "name": "search",
                        "in": "query"
                    }
                ],
        ...
        "/api/admin/seo": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.SEOPage"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create SEO configuration request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateSEOPageRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/seo/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "SEO Configuration ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Update SEO configuration request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateSEOPageRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/testimonials": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Testimonial Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateTestimonialRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/testimonials/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Testimonial Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateTestimonialRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/contact": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Contact inquiry submission data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.ContactInquiry"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/loan-inquiry": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Loan inquiry application data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.LoanInquiryRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.LoanInquiry"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/seo": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Page slug (e.g. home, about, services, contact)",
                        "name": "slug",
                        "in": "query",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "dto.UpdateInquiryStatusRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "services.DashboardStats": {
            "type": "object",
            "properties": {
                "total_contact_inquiries": {
                    "type": "integer"
                },
                "total_loan_inquiries": {
                    "type": "integer"
                },
                "total_services": {
                    "type": "integer"
